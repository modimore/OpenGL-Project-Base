#ifndef _Cube_ARGPARSER_HPP_
#define _Cube_ARGPARSER_HPP_

#include "../../base/ArgParser.hpp"

class CubeArgParser : public ArgParser {
public:
  ...
  // Default Constructor
  CubeArgParser() : ArgParser() { }
  // Command Line Parameters Constructor
  CubeArgParser(int argc, char* argv[]) : ArgParser()
  {
